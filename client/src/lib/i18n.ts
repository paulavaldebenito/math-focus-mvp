...
const STRINGS = {
  es: {
    ...
    createChildSubtitle: "MVP: 1° y 2° básico, eje Números y operaciones. Sin datos de salud ni diagnósticos.",
    createChildNameLabel: "Nombre",
    createChildGradeLabel: "Curso",
    grade1Label: "1° básico",
    grade2Label: "2° básico",
  ...
  en: {
    ...
    createChildSubtitle: "MVP: 1st and 2nd grade, Numbers and Operations strand. No health data or diagnoses.",
    createChildNameLabel: "Name",
    createChildGradeLabel: "Grade",
    grade1Label: "1st grade",
    grade2Label: "2nd grade",
