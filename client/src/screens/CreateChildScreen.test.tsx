...
describe("CreateChildScreen", () => {
  ...
  it("crea el perfil con el consentId recibido y llama onCreated", async () => {
    ...
    expect(mocks.createChild).toHaveBeenCalledWith("consent-abc", "Ana");
    expect(onCreated).toHaveBeenCalledWith({ id: "child-1", displayName: "Ana", grade: 1, language: "es" });
  });
});
